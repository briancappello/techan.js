(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.techanjs = {}, global.d3));
  ...
  function indicatorFactory(d3) {
    ...
    return {
      ...
      stochastic: stochastic_init(indicatorMixin, accessor.ohlc),
  ...
  const indicator = indicatorFactory(d3__namespace);
  const plot = plotFactory(d3__namespace);
  const scale = scaleFactory(d3__namespace);
...
//# sourceMappingURL=techan.js.map
